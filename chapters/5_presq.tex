...
- definitive layout
- statistically robust algorithm for finding them.

In section~\ref{sec:literature_review}, we briefly discuss
...
\ref{sec:conclusions}, we compile the conclusions and propose areas for
further work.

\section{Background}
\label{sec:background}

Background was moved to gaps. Rename, I don't know... definitions?
