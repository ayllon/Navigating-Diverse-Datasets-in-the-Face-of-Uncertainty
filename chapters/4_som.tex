...
We have implemented our proposal using Somuclu, a parallel tool for training self-organizing maps
...
We have run two examples from the \PresQ paper using the proposed SOM based test
