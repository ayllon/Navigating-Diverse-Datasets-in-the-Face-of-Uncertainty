Most of content on this chapter appears in the article
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{images/3_presq/no2ind}
    \caption{
...
(run-time), efficacy (capability of finding high-arity \glspl{EDD}), and efficiency (avoidance of
redundant results).

\textbf{Paper organization:} In section~\ref{sec:literature_review}, we briefly discuss
existing work done on \gls{IND} discovery.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{images/3_presq/lattice}
    \caption{
...
% This property is similar to the one proposed for \glspl{IND}\cite{DeMarchi2002}, with the exception that even if $d \models I_2$, there is a probability to falsely reject $I_1$ bound by the significance level $\alpha$.
...
\ref{sec:literature_review}, only three of the existing \gls{IND} finding solutions are not strongly
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/3_presq/pipeline}
...
\begin{figure}[ht]
    \centering
    \includegraphics{images/3_presq/hypergeom}
...
\begin{figure}[ht]
    \centering
    \includegraphics{images/3_presq/3hyper_beta}
...
\begin{figure}[ht]
    \centering
    \includegraphics{images/3_presq/3hyper_alpha}
    \caption{Recovery ratio and run-times for cliques on uniform $3$-hypergraphs
...
\begin{figure}[ht]
    \centering
    \includegraphics{images/3_presq/quasi_corr_20}
    \caption{
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{images/3_presq/afds}
    \caption{
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\linewidth]{images/3_presq/all}
    \caption{
...
\begin{figure*}[htb]
    \centering
    \includegraphics{images/3_presq/scalability}
...
\begin{figure}[htb]
    \centering
    \includegraphics{images/3_presq/scalability_sample_wave}
    \caption{
...
This problem can be mapped to finding quasi-cliques, as the \gls{IND} problem can be mapped
to finding full cliques.

In this paper, we have introduced the concept of EDD, similar to the \gls{IND} from the relational
...
find very high arity \glspl{EDD}, given the complexity of the \gls{IND}/\gls{EDD} discovery
