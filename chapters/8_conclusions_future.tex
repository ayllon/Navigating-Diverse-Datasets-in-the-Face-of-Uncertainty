...
In chapter~\ref{chapter:diverse}, we have confirmed that users spend a non-negligible
...
In chapter~\ref{chapter:som}, we have introduced a two-sample multivariate statistical test based on
...
\begin{itemize}
    ...
    Being able to merge complementary datasets would be a powerful addition to \gls{EDD} finding.
\end{itemize}
