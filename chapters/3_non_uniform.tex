...
\end{tabular}
\caption{Combination of relations most frequently queries. Tables marked with (\textasteriskcentered)
are meta-data tables (i.e., describe the schema)}\label{tab:most_tables}
\end{table}
